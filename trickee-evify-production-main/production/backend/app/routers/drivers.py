...
from app.models import Driver, DriverCoachingEvent, Telemetry, Trip, User
...
async def create_driver_coaching(
    ...
    if payload.custom_message:
        coaching_event = DriverCoachingEvent(
            driver_id=driver.id,
        ...
        db.commit()
        return ok({
            "message": coaching_event.message,
            "metrics": coaching_event.metrics,
            "tips": coaching_event.tips,
            "tone": coaching_event.tone,
            "confidence": coaching_event.confidence,
        })
