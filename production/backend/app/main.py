...
from app.routers import admin, alerts, assistant, auth, battery, chargers, drivers, fleet, intelligence, mobile, notifications, predictions, routes, telemetry, vehicles, ws
